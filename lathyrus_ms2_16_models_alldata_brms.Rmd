...
plot_grid(ggplot()+
          ...
          plot_grid(ggplot(BLUPs_MCMC.all.brms,
                      ...
                      geom_histogram(fill="lightgrey",color="black")+my_theme()+
...
```{r}
arrayS2<-as.array(bivar1.all.brm.nb)
dimnames(arrayS2)[[3]][1:11] <- 
  c("Intercept of FFD","Intercept of fitness","April temperature on FFD",
    "Individual: SD\n(intercept of FFD)",
    "Individual: SD\n(slope of FFD)","Individual: SD\n(intercept of fitness)",
    "Year: SD\n(intercept of FFD)",
    ...
    "Individual: correlation\n(intercept of FFD, intercept of fitness)",
    "Individual: correlation\n(slope of FFD, intercept of fitness)","Sigma FFD")
mcmc_trace(arrayS2,pars=c("Intercept of FFD","Intercept of fitness",
                          "April temperature on FFD",
                          "Individual: SD\n(intercept of FFD)"),
                          facet_args = list(ncol = 1, strip.position = "left"))
ggsave(filename="output/figures/figS1_7a.tiff",
        device="tiff",width=20,height=28,units="cm",dpi=300,compression="lzw")
mcmc_trace(arrayS2,pars=c(
  "Individual: SD\n(slope of FFD)","Individual: SD\n(intercept of fitness)",
  "Year: SD\n(intercept of FFD)",
  "Individual: correlation\n(intercept of FFD,slope of FFD)"),
           facet_args = list(ncol = 1, strip.position = "left"))
...
```{r message=FALSE, warning=FALSE}
plot_grid(mcmc_rhat_hist(rhat(bivar1.all.brm.nb))+my_theme_legend()+
            theme(legend.position="top")+
            theme(legend.text=element_text(size=10)),
          mcmc_neff_hist(neff_ratio(bivar1.all.brm.nb))+my_theme_legend()+
            theme(legend.position="top")+
            theme(legend.text=element_text(size=10)),
          labels = c("A)","B)"),label_fontfamily="serif")
...
```{r}
plot_grid(ppc_dens_overlay(y2_fitness, yrep2_fitness_nb[1:100,])+
            my_theme_legend()+
            theme(axis.ticks.y=element_blank(),axis.text.y=element_blank(),
                  legend.position="top"),
          ppc_dens_overlay(y2_FFD, yrep2_FFD_nb[1:100,])+my_theme_legend()+
            theme(axis.ticks.y=element_blank(),axis.text.y=element_blank(),
                  legend.position="top"),
          labels = c("A)","B)"),label_fontfamily="serif")
...
```{r}
arrayS3A<-as.array(bivar3.all.brm.nb)
dimnames(arrayS3A)[[3]][1:11] <- 
  c("Intercept of FFD","Intercept of fitness","April temperature on FFD",
    "Individual: SD\n(intercept of FFD)",
    "Individual: SD\n(slope of FFD)","Individual: SD\n(intercept of fitness)",
    "Year: SD\n(intercept of FFD)",
    ...
    "Individual: correlation\n(intercept of FFD, intercept of fitness)",
    "Individual: correlation\n(slope of FFD, intercept of fitness)","Sigma FFD")
mcmc_trace(arrayS3A,pars=c("Intercept of FFD","Intercept of fitness",
                          "April temperature on FFD",
                          "Individual: SD\n(intercept of FFD)"),
                          facet_args = list(ncol = 1, strip.position = "left"))
ggsave(filename="output/figures/figS1_10a.tiff",
        device="tiff",width=20,height=28,units="cm",dpi=300,compression="lzw")
mcmc_trace(arrayS3A,pars=c(
  "Individual: SD\n(slope of FFD)","Individual: SD\n(intercept of fitness)",
  "Year: SD\n(intercept of FFD)",
  "Individual: correlation\n(intercept of FFD,slope of FFD)"),
           facet_args = list(ncol = 1, strip.position = "left"))
...
```{r message=FALSE, warning=FALSE}
plot_grid(mcmc_rhat_hist(rhat(bivar3.all.brm.nb))+my_theme_legend()+
            theme(legend.position="top")+
            theme(legend.text=element_text(size=10)),
          mcmc_neff_hist(neff_ratio(bivar3.all.brm.nb))+my_theme_legend()+
            theme(legend.position="top")+
            theme(legend.text=element_text(size=10)),
          labels = c("A)","B)"),label_fontfamily="serif")
...
```{r}
plot_grid(ppc_dens_overlay(y3_fitness, yrep4_fitness_nb[1:100,])+
            my_theme_legend()+
            theme(axis.ticks.y=element_blank(),axis.text.y=element_blank(),
                  legend.position="top"),
          ppc_dens_overlay(y2_FFD, yrep4_FFD_nb[1:100,])+my_theme_legend()+
            theme(axis.ticks.y=element_blank(),axis.text.y=element_blank(),
                  legend.position="top"),
          labels = c("A)","B)"),label_fontfamily="serif")
...
datadef%>%
  ...
  xlab("April temperature (ºC)")+ylab("SD of FFD")
datadef%>%
  group_by(year)%>%
  summarise(sd_FFD=sd(FFD,na.rm=T),mean_4=mean(mean_4))%>%
